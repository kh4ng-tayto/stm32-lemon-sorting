...
* **Tổng số lượng:** 2.524 ảnh thực tế với nhiều bối cảnh, góc chụp và điều kiện ánh sáng khác nhau[cite: 1].
* **Số lượng đối tượng:** 3.353 đối tượng đã được gán nhãn (Bounding Box)[cite: 1].
* **Phân bổ lớp (Class):**
  * `Good` (Chanh tốt): 1.884 đối tượng[cite: 1].
  * `Bad` (Chanh hỏng): 1.469 đối tượng[cite: 1].
* **Tỷ lệ phân chia:** Train (2.030 ảnh) - Validation (246 ảnh) - Test (248 ảnh)[cite: 1].
